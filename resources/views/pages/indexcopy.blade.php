...
{{-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script> --}}a
<script src="{{asset('public/frontend/js/jquery.min.js')}}"></script>

@php
 $featured=DB::table('products')->where('status',1)->orderBy('id','desc')->where('is_approved','1')->get();    //sob_product(available)
 $trend=DB::table('products')->where('status',1)->where('trend',1)->orderBy('id','desc')->where('is_approved','1')->limit(24)->get();
 $best=DB::table('products')->where('status',1)->where('best_rated',1)->where('is_approved','1')->orderBy('id','desc')->limit(24)->get();
 $hot=DB::table('products')->join('brands','products.brand_id','brands.id')->select('brands.brand_name','products.*')->where('products.status',1)->where('hot_deal',1)->orderBy('id','desc')->where('is_approved','1')->limit(4)->get();
@endphp
    <!-- Characteristics -->
...
@php
    $mid=DB::table('products')
        ...
        ->where('products.mid_slider',1)->where('products.is_approved','1')
...
$category_id=$cats->id;
$products=DB::table('products')->where('category_id',$category_id)->where('status',1)->where('is_approved','1')->orderBy('id','DESC')->get();
@endphp
...
@php
$buyget=DB::table('products')->where('status',1)->where('buyone_getone',1)->orderBy('id','desc')->where('is_approved','1')->limit(12)->get();
@endphp
            <!-- Trends Slider -->
            <div class="col-lg-9">
