...
<body>
    ...
    <div class="sl-sideleft">
        <div class="sl-sideleft-menu">
            ...
            @if(Auth::user()->banner_slider == 1)
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
                    <span class="menu-item-label">Banner Slider</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('banner-slider')}}" class="nav-link">All Banner</a></li>
            </ul>
            @else
            @endif


            @if(Auth::user()->mid_slider == 1)
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
                    <span class="menu-item-label">Middle Slider</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('mid-banner')}}" class="nav-link">All Middle Banner</a></li>

                <li class="nav-item"><a href="{{route('mid-banner.create')}}" class="nav-link">Add Middle Banner</a></li>
            ...
            @if(Auth::user()->promotional_slider == 1)
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
                    <span class="menu-item-label">Prmotional Slider</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('promotional-slider')}}" class="nav-link">All Prmotional Slider</a></li>

                <li class="nav-item"><a href="{{route('promotional-slider.create')}}" class="nav-link">Add Prmotional Slider</a></li>
                
            </ul>
            @else
            @endif

            @if(Auth::user()->seller_list == 1)
            <a href="{{route('seller-list')}}" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
                    <span class="menu-item-label">Seller List</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            @else
            @endif
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{route('childcategories')}}" class="nav-link">Child Category</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('product.pending') }}" class="nav-link">Pending Products</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.neworder') }}" class="nav-link">New Pending Orders</a>
                </li>
                <li class="nav-item"><a href="{{ route('admin.accept.payment') }}" class="nav-link">Accept Payments</a>
                </li>
                <li class="nav-item"><a href="{{ route('admin.progress.payment') }}" class="nav-link">Progress
                        Delivery</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('today.order') }}" class="nav-link">Today Pending Order</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('admin.product.stockOut') }}" class="nav-link">Stock Out Product</a></li>
            </ul>
            @else
            @endif
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('comment.newReview')}}" class="nav-link">New Comment</a></li>
                <li class="nav-item"><a href="{{route('comment.index')}}" class="nav-link">All Comment</a></li>
            </ul>
            @else
            @endif
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('admin.database.backup') }}" class="nav-link">Databse Backup </a>
                </li>
            </ul>
            @else
            @endif
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            ...
                            <li><a href="{{route('show-seller-business-profile')}}">{{-- <i class="icon ion-ios-business-outline"></i> --}}
