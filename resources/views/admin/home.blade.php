      ...
      <div class="sl-pagebody">
         ...
         <div class="row row-sm mg-t-20">
          <div class="col-lg-12">
            <div class="card pd-20 pd-sm-20">
              <h6 class="card-body-title">Welcome {{Auth::user()->name}}</h6>
              <p>Your Details are under validation please. For any help contact on our email id thank you.</p>
            </div>
          </div>
        </div>
        @else
        <div class="row row-sm mg-t-20">
          <div class="col-lg-12">
            <div class="card pd-20 pd-sm-20">
              <h6 class="card-body-title">Welcome {{Auth::user()->name}}</h6>
              <p>Please Complete Your Business Profile For Start Your Journey With Ciero Jewels.</p>
              <a href="{{route('complete-business-profile')}}" class="btn btn-info mg-r-5">Complete Your Business Profile</a>
            </div>
          </div>
        </div>
        @endif
