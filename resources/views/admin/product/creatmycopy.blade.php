...
<!------ Form Starts --------->
        ...
        <div class="form-layout">
          <div class="row mg-b-25">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                <label class="form-control-label">Product width: <span class="tx-danger">*</span></label><br>
                <input class="form-control" type="text" name="width" id="size">
              </div>
            </div><!-- col-4 -->

            <div class="col-lg-4">
              <div class="form-group">
                <label class="form-control-label">Product Height: <span class="tx-danger">*</span></label><br>
                <input class="form-control" type="text" name="height" id="size" >
              </div>
            </div><!-- col-4 -->
            ...
            <div class="col-lg-4">
              <div class="form-group">
                <label class="form-control-label">Product Gross Weight: <span class="tx-danger">*</span></label><br>
                <input class="form-control" type="text" name="gross_weight" id="size" >
              </div>
            </div><!-- col-4 -->

            <div class="col-lg-4">
              <div class="form-group">
                <label class="form-control-label">Product Material: <span class="tx-danger">*</span></label><br>
                <input class="form-control lg-4" type="text" name="material" data-role="tagsinput" id="color" >
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-4">
              <div class="form-group">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="mrp"  placeholder="Selling Price">
              </div>
            </div><!-- col-4 -->
            ...
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="discount"  readonly placeholder="Selling Price">
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-12">
                <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      {{-- JQ for getting "subcategory" after "category" --}}
       ...
       {{-- JQ for getting "childcategory" after "subcategory" --}}
