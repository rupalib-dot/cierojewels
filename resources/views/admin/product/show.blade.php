            ...
            <div class="col-lg-4">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Category: <span class="tx-danger">*</span></label>
                 <br>
                <strong>{{ (isset($product->Category) ? $product->Category->category_name: '' ) }}</strong>
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-4">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Sub Category: <span class="tx-danger">*</span></label>
                 <br>
                <strong>{{ (isset($product->Subcategory) ? $product->Subcategory->category_name: '' ) }}</strong>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Child Category: <span class="tx-danger">*</span></label>
                 <br>
                <strong>{{ (isset($product->Childcategory) ? $product->Childcategory->category_name: '' ) }}</strong>
              </div>
            </div><!-- col-4 -->
            {{-- <div class="col-lg-4">
              <div class="form-group mg-b-10-force">
