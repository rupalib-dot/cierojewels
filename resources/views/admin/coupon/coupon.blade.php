...
{{-- form --}}
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="coupon" id="coupon" required placeholder="Enter Coupon Name">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="category" class="form-control" placeholder="Search Category" id="search_category">
