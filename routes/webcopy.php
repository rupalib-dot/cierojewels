...
Route::get('/callback/{provider}', 'SocialController@callback');
        //-------------Wishlists-------------
Route::get('add/wishlist/{id}','WishlistController@AddWishlist')->middleware('verified');
        //------------Cart------------------
...
Route::get('user/wishlist/','CartController@Wishlist')->name('user.wishlist')->middleware('verified');  //--nav--
Route::get('user/wishlist/remove/{id}','CartController@Remove')->middleware('verified');
...
Route::post('/password/update', 'HomeController@updatePassword')->name('update.password');
            ...
            //-------admin---------------
Route::get('admin/home', 'AdminController@index')->middleware('verified');
